...
// Member list is used as History has no default constructor
Arena::Arena(int nRows, int nCols)
    : m_history(MAXROWS, MAXCOLS)
{
    ...
    m_player = nullptr;
    m_nVampires = 0;
    m_history = History(m_rows, m_cols); // Initializes history data member properly
    m_turns = 0;
